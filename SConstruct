...
opts.Add('enable_tests', 'Should the unit tests be enabled', 0)
opts.Add('enable_tools', 'Should the developer tools be build', 1)
#opts.Add('enable_profiling', 'Should code profiling be enabled', 0)
opts.Add('enable_python', 'Build python wrapper? (swig required)', 0)
opts.Add('debug_modules', 'Should unloading of shared modules be avoided (DEBUGGING ONLY!)', 0)
