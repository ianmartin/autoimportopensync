...
static void vcard_handle_parameter(GHashTable *hooks, xmlNode *current, VFormatParam *param)
{
	...
	char *paramname = g_strdup_printf("%s=%s", vformat_attribute_param_get_name(param), property_get_nth_value(param, 0));
...
static VFormatAttribute *handle_xml_fullname_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_FN);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
{
	osync_trace(TRACE_INTERNAL, "Handling fullname xml attribute");
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_N);
...
static VFormatAttribute *handle_xml_photo_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_PHOTO);
	add_value(attr, root, "Content", encoding);
...
static VFormatAttribute *handle_xml_birthday_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_BDAY);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_address_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_ADR);
...
static VFormatAttribute *handle_xml_label_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_LABEL);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_telephone_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_TEL);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_email_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_EMAIL);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_mailer_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_MAILER);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_title_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_TITLE);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_role_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_ROLE);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_organization_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_ORG);
...
static VFormatAttribute *handle_xml_note_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_NOTE);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_revision_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_REV);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_url_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_URL);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_uid_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_UID);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static VFormatAttribute *handle_xml_key_attribute(VFormat *vcard, xmlNode *root, const char *encoding)
{
	...
	VFormatAttribute *attr = vformat_attribute_new(NULL, EVC_KEY);
	add_value(attr, root, "Content", encoding);
	vformat_add_attribute(vcard, attr);
	return attr;
}
...
static osync_bool conv_xml_to_vevent(void *user_data, char *input, int inpsize, char **output, int *outpsize, osync_bool *free_input, OSyncError **error)
{
	...
	//Make the new vcard
	g_type_init();
	VFormat *vcard = e_vevent_new();
	
	osync_trace(TRACE_INTERNAL, "parsing cml attributes");
	while (root) {
		xml_vevent_handle_attribute((OSyncHookTables *)user_data, vcard, root, std_encoding);
		root = root->next;
	}
...
static char *print_vevent(OSyncChange *change)
{
...
static void *init_vevent_to_xml(void)
{
...
static void *init_xml_to_vevent(void)
{
	osync_trace(TRACE_ENTRY, "%s", __func__);
...
static void fin_xml_to_vevent(void *data)
{
...
void get_info(OSyncEnv *env)
{
	...
	osync_env_format_set_compare_func(env, "xml-event", compare_event);
	osync_env_format_set_destroy_func(env, "xml-event", destroy_xml);
	osync_env_format_set_print_func(env, "xml-event", print_event);
	osync_env_format_set_copy_func(env, "xml-event", osxml_copy);
	
	osync_env_register_converter(env, CONVERTER_CONV, "vevent", "xml-event", conv_vevent_to_xml);
	osync_env_converter_set_init(env, "vevent", "xml-event", init_vevent_to_xml, fin_vevent_to_xml);
	osync_env_register_converter(env, CONVERTER_CONV, "xml-event", "vevent", conv_xml_to_vevent);
	osync_env_converter_set_init(env, "xml-event", "vevent", init_xml_to_vevent, fin_xml_to_vevent);
}
