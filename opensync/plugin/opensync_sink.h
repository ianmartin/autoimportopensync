...
typedef osync_bool (* OSyncSinkCommitFn) (void *data, OSyncPluginInfo *info, OSyncContext *ctx, OSyncChange *);
typedef osync_bool (* OSyncSinkAccessFn) (void *data, OSyncPluginInfo *info, OSyncContext *ctx, OSyncChange *);
