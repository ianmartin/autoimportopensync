...
OSYNC_TEST_EXPORT OSyncClientProxy *osync_client_proxy_new(OSyncFormatEnv *formatenv, OSyncMember *member, OSyncError **error);
OSYNC_TEST_EXPORT OSyncClientProxy *osync_client_proxy_ref(OSyncClientProxy *proxy);
OSYNC_TEST_EXPORT void osync_client_proxy_unref(OSyncClientProxy *proxy);
...
OSYNC_TEST_EXPORT osync_bool osync_client_proxy_finalize(OSyncClientProxy *proxy, finalize_cb callback, void *userdata, OSyncError **error);
...
OSYNC_TEST_EXPORT osync_bool osync_client_proxy_discover(OSyncClientProxy *proxy, discover_cb callback, void *userdata, OSyncError **error);
...
OSYNC_TEST_EXPORT int osync_client_proxy_num_objtypes(OSyncClientProxy *proxy);
OSYNC_TEST_EXPORT OSyncObjTypeSink *osync_client_proxy_nth_objtype(OSyncClientProxy *proxy, int nth);
