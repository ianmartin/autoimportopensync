...
OSYNC_EXPORT osync_bool osync_archive_save_data(OSyncArchive *archive, const char *uid, long long int memberid, const char *data, unsigned int size, OSyncError **error);
OSYNC_EXPORT osync_bool osync_archive_load_data(OSyncArchive *archive, const char *uid, long long int memberid, char **data, unsigned int *size, OSyncError **error);
