...
#define SERVER_ALERT_CODE                       TEXT("The server alert code for %ls is %i")
#define SYNCHRONIZING                           TEXT("Synchronizing %ls")
    
#define PREPARING_FAST_SYNC                     TEXT("Preparing fast sync for %ls")
#define PREPARING_SLOW_SYNC                     TEXT("Preparing slow sync for %ls")
...
#define RETURNED_NUM_ITEMS                      TEXT("Returned %i new items, %i updated items, %i deleted items for %ls")
...
#define RESPURI                                 TEXT("url from response to inizialization-message: %ls")
