...
IF ( LIBWBXML2_MIN_VERSION )
	...
	SET (_pkgconfig_version ">=${LIBWBXML2_MIN_VERSION}" )
...
IF ( NOT LIBWBXML2_FOUND AND PKG_CONFIG_FOUND )
	IF ( LibWbxml2_FIND_REQUIRED )
		MESSAGE( FATAL_ERROR "Could NOT find libwbxml2${_pkgconfig_version}" )
	ELSE ( LibWbxml2_FIND_REQUIRED )
		IF ( NOT LibWbxml2_FIND_QUIETLY )
			MESSAGE( SEND_ERROR "Could NOT find libwbxml2${_pkgconfig_version}" )	
		ENDIF ( NOT LibWbxml2_FIND_QUIETLY )
	ENDIF ( LibWbxml2_FIND_REQUIRED )
ENDIF ( NOT LIBWBXML2_FOUND AND PKG_CONFIG_FOUND )
...
IF( NOT LIBWBXML2_FOUND AND NOT PKG_CONFIG_FOUND )
	...
	ELSE ( LIBWBXML2_LIBRARIES AND LIBWBXML2_INCLUDE_DIRS AND _libwbxml2_FOUND )	
		IF ( LibWbxml2_FIND_REQUIRED )
			MESSAGE( FATAL_ERROR "Could NOT find libwbxml2" )
		ELSE ( LibWbxml2_FIND_REQUIRED )
			IF ( NOT LibWbxml2_FIND_QUIETLY )
