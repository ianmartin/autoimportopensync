...
IF ( NOT LIBSYNCML_FOUND AND NOT PKG_CONFIG_FOUND )
	...
	IF( NOT LIBXML2_FOUND )
		...
		IF ( LIBXML2_FOUND )
			SET ( LIBSYNCML_INCLUDE_DIRS ${LIBSYNCML_INCLUDE_DIRS} ${LIBXML2_INCLUDE_DIR} )
	...
	IF ( NOT GLIB2_FOUND )
                ...
                IF ( GLIB2_FOUND )
                        SET ( LIBSYNCML_INCLUDE_DIRS ${LIBSYNCML_INCLUDE_DIRS} ${GLIB2_INCLUDE_DIR} ${GLIBCONFIG_INCLUDE_DIR} )
                        SET ( LIBSYNCML_LIBRARIES ${LIBSYNCML_LIBRARIES} ${GLIB2_LIBRARY} )
                ENDIF ( GLIB2_FOUND )
...
ENDIF ( LIBSYNCML_FOUND AND NOT PKG_CONFIG_FOUND )
