...
IF ( LIBSOUP2_MIN_VERSION )
	PKG_SEARCH_MODULE( LIBSOUP2 libsoup-2.2>=${LIBSOUP2_MIN_VERSION} libsoup2>=${LIBSOUP2_MIN_VERSION} ${_pkgconfig_REQUIRED} )
	SET (_pkgconfig_version ">=${LIBSOUP2_MIN_VERSION}" )
ELSE ( LIBSOUP2_MIN_VERSION )
	PKG_SEARCH_MODULE( LIBSOUP2 libsoup-2.2 libsoup2 ${_pkgconfig_REQUIRED} )
	SET (_pkgconfig_version "" )
ENDIF ( LIBSOUP2_MIN_VERSION )

IF ( NOT LIBSOUP2_FOUND AND PKG_CONFIG_FOUND )
	IF ( LibSoup2_FIND_REQUIRED )
		MESSAGE( FATAL_ERROR "Could NOT find libsoup2${_pkgconfig_version}" )
	ELSE ( LibSoup2_FIND_REQUIRED )
		IF ( NOT LibSoup2_FIND_QUIETLY )
			MESSAGE( SEND_ERROR "Could NOT find libsoup2${_pkgconfig_version}" )	
		ENDIF ( NOT LibSoup2_FIND_QUIETLY )
	ENDIF ( LibSoup2_FIND_REQUIRED )
ENDIF ( NOT LIBSOUP2_FOUND AND PKG_CONFIG_FOUND )
