...
IF ( NOT LIBEDATASERVER1.0_FOUND AND PKG_CONFIG_FOUND )
	IF ( EDataServer1.0_FIND_REQUIRED )
		MESSAGE( FATAL_ERROR "Could NOT find libedataserver-1.0" )
	ELSE ( EDataServer1.0_FIND_REQUIRED )
		IF ( NOT EDataServer1.0_FIND_QUIETLY )
			MESSAGE( SEND_ERROR "Could NOT find libedataserver-1.0" )
		ENDIF ( NOT EDataServer1.0_FIND_QUIETLY )
	ENDIF ( EDataServer1.0_FIND_REQUIRED )
ENDIF ( NOT LIBEDATASERVER1.0_FOUND AND PKG_CONFIG_FOUND )
...
IF ( NOT LIBEDATASERVER1.0_FOUND )
	...
	IF ( NOT LIBXML2_FOUND )
		FIND_PACKAGE ( LibXml2 REQUIRED )
                IF ( LIBXML2_FOUND )
                        SET ( LIBEDATASERVER1.0_INCLUDE_DIRS ${LIBEDATASERVER1.0_INCLUDE_DIRS} ${LIBXML2_INCLUDE_DIR} )
	...
	IF ( NOT GLIB2_FOUND )
		FIND_PACKAGE ( GLIB2 REQUIRED )
                IF ( GLIB2_FOUND )
                        SET ( LIBEDATASERVER1.0_INCLUDE_DIRS ${LIBEDATASERVER1.0_INCLUDE_DIRS} ${GLIB2_INCLUDE_DIR} ${GLIBCONFIG_INCLUDE_DIR} )
                        SET ( LIBEDATASERVER1.0_LIBRARIES ${LIBEDATASERVER1.0_LIBRARIES} ${GLIB2_LIBRARY} )
                ENDIF ( GLIB2_FOUND )		
