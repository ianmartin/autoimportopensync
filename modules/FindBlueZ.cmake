...
IF ( BLUEZ_MIN_VERSION )
	PKG_SEARCH_MODULE( BLUEZ bluez>=${BLUEZ_MIN_VERSION} ${_pkgconfig_REQUIRED} )
	SET (_pkgconfig_version ">=${BLUEZ_MIN_VERSION}" )
ELSE ( BLUEZ_MIN_VERSION )
	PKG_SEARCH_MODULE( BLUEZ bluez ${_pkgconfig_REQUIRED} )
	SET (_pkgconfig_version "" )
ENDIF ( BLUEZ_MIN_VERSION )

IF ( NOT BLUEZ_FOUND AND PKG_CONFIG_FOUND )
	IF ( BlueZ_FIND_REQUIRED )
		MESSAGE( FATAL_ERROR "Could NOT find BlueZ${_pkgconfig_version}" )
	ELSE ( BlueZ_FIND_REQUIRED )
		IF ( NOT BlueZ_FIND_QUIETLY )
			MESSAGE( SEND_ERROR "Could NOT find BlueZ${_pkgconfig_version}" )	
		ENDIF ( NOT BlueZ_FIND_QUIETLY )
	ENDIF ( BlueZ_FIND_REQUIRED )
ENDIF ( NOT BLUEZ_FOUND AND PKG_CONFIG_FOUND )
