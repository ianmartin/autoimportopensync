 ...
 *
 * Changelog:
 *    + Port to linux: changed %s to %ls in templates /mk
 */

// for clear auth 
// const wchar_t* xmlInit  = TEXT("<SyncML>\n<SyncHdr>\n<VerDTD>1.1</VerDTD>\n<VerProto>SyncML/1.1</VerProto>\n<SessionID>1</SessionID>\n<MsgID>1</MsgID>\n<Target><LocURI>%ls</LocURI></Target>\n<Source><LocURI>%ls</LocURI></Source>\n<Cred>\n<Meta><Type xmlns='syncml:metinf'>syncml:auth-clear</Type></Meta>\n<Data>%ls:%ls</Data>\n</Cred>\n</SyncHdr>\n<SyncBody>\n%ls\n<Final/>\n</SyncBody>\n</SyncML>");
